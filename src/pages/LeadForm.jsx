            ...
            <div className="space-y-5">
              <FormField label={t('lead.step1.fullName')} required error={errors.fullName}>
                <input
                  ...
                  placeholder={t('lead.step1.fullNamePlaceholder')}
                  autoComplete="name"
              ...
              <FormField label={t('lead.step1.phone')} required error={errors.phone}>
                <input
                  ...
                  placeholder={t('lead.step1.phonePlaceholder')}
                  autoComplete="tel"
                  className={inputClass}
              ...
              <FormField label={t('lead.step1.company')} error={errors.company}>
                <input
                  type="text"
                  id="company"
                  value={form.company}
                  onChange={(e) => update('company', e.target.value)}
                  placeholder={t('lead.step1.companyPlaceholder')}
