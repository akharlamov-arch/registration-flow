  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-4 py-3.5 mb-6">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-semibold text-red-800">{t('attention.reminder.title')}</p>
        <p className="text-sm text-red-700 mt-0.5 leading-relaxed">{t('attention.reminder.body')}</p>
      </div>
      <button
        type="button"
        onClick={onGo}
