  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-4 py-3.5 mb-6">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm font-semibold text-red-800">Bank account not connected yet</p>
        <p className="text-sm text-red-700 mt-0.5 leading-relaxed">
          Your updated contract is signed. Connect your bank account to finish — payments cannot be issued until it is verified.
        </p>
      </div>
      <button
        type="button"
